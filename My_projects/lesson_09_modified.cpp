...
//g++ lesson_09_modified.cpp  -g -std=c++17 -I /mnt/g/Halide_Language/Halide-13.0.2-x86-64-linux/include/ -I /mnt/g/Halide_Language/Halide-13.0.2-x86-64-linux/share/Halide/tools/ -L /mnt/g/Halide_Language
// /Halide-13.0.2-x86-64-linux/lib/ -lHalide `libpng-config --cflags --ldflags` -ljpeg -lpthread -ldl -fopenmp -o lesson_09_modified
