#ifndef HALIDE_____my_first_gen_h
#define HALIDE_____my_first_gen_h
#include <stdint.h>
...
int my_first_gen(uint8_t _offset, struct halide_buffer_t *_input_buffer, struct halide_buffer_t *_brighter_buffer);

HALIDE_FUNCTION_ATTRS
int my_first_gen_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *my_first_gen_metadata();
