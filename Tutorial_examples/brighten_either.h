#ifndef HALIDE_____brighten_either_h
#define HALIDE_____brighten_either_h
#include <stdint.h>
...
int brighten_either(struct halide_buffer_t *_input_buffer, uint8_t _offset, struct halide_buffer_t *_brighter_buffer);

HALIDE_FUNCTION_ATTRS
int brighten_either_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *brighten_either_metadata();
