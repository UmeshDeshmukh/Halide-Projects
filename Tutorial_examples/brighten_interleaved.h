#ifndef HALIDE_____brighten_interleaved_h
#define HALIDE_____brighten_interleaved_h
#include <stdint.h>
...
int brighten_interleaved(struct halide_buffer_t *_input_buffer, uint8_t _offset, struct halide_buffer_t *_brighter_buffer);

HALIDE_FUNCTION_ATTRS
int brighten_interleaved_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *brighten_interleaved_metadata();
