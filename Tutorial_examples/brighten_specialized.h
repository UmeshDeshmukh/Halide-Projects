#ifndef HALIDE_____brighten_specialized_h
#define HALIDE_____brighten_specialized_h
#include <stdint.h>
...
int brighten_specialized(struct halide_buffer_t *_input_buffer, uint8_t _offset, struct halide_buffer_t *_brighter_buffer);

HALIDE_FUNCTION_ATTRS
int brighten_specialized_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *brighten_specialized_metadata();
